    ...
    def get_resources(self):
        ...
        for resource_field in resource_fields.find_all(class_="level"):
            ...
            if "gid1" in classes:
                ...
                building_type = "Clay Pit"
            elif "gid3" in classes:
                building_type = "Iron Mine"
            elif "gid4" in classes:
                building_type = "Cropland"
            ...
            self.buildings.append(Building(building_type, level, slot, gid, under_construction))
